...
// NewSBTLicenseReportParser returns a new instance of SBTLicenseReport Parser
func NewSBTLicenseReportParser() *SBTLicenseReport {
	return &SBTLicenseReport{}
}
...
func (sbt *SBTLicenseReport) parseLine(line string) (*Dependency, error) {
	...
	if len(moduleInfo) != 3 {
		return nil, fmt.Errorf("Unable to parse the module info for the record")
	}
